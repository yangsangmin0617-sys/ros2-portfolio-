...
erp42_msgs__msg__SerialFeedBack__create()
{
  ...
  erp42_msgs__msg__SerialFeedBack * msg = (erp42_msgs__msg__SerialFeedBack *)allocator.allocate(sizeof(erp42_msgs__msg__SerialFeedBack), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(erp42_msgs__msg__SerialFeedBack));
  bool success = erp42_msgs__msg__SerialFeedBack__init(msg);
  if (!success) {
...
erp42_msgs__msg__SerialFeedBack__destroy(erp42_msgs__msg__SerialFeedBack * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    erp42_msgs__msg__SerialFeedBack__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
erp42_msgs__msg__SerialFeedBack__Sequence__init(erp42_msgs__msg__SerialFeedBack__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  erp42_msgs__msg__SerialFeedBack * data = NULL;

  if (size) {
    data = (erp42_msgs__msg__SerialFeedBack *)allocator.zero_allocate(size, sizeof(erp42_msgs__msg__SerialFeedBack), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = erp42_msgs__msg__SerialFeedBack__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        erp42_msgs__msg__SerialFeedBack__fini(&data[i - 1]);
      }
...
erp42_msgs__msg__SerialFeedBack__Sequence__fini(erp42_msgs__msg__SerialFeedBack__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      erp42_msgs__msg__SerialFeedBack__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  erp42_msgs__msg__SerialFeedBack__Sequence * array = (erp42_msgs__msg__SerialFeedBack__Sequence *)allocator.allocate(sizeof(erp42_msgs__msg__SerialFeedBack__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = erp42_msgs__msg__SerialFeedBack__Sequence__init(array, size);
  if (!success) {
...
erp42_msgs__msg__SerialFeedBack__Sequence__destroy(erp42_msgs__msg__SerialFeedBack__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    erp42_msgs__msg__SerialFeedBack__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
erp42_msgs__msg__SerialFeedBack__Sequence__are_equal(const erp42_msgs__msg__SerialFeedBack__Sequence * lhs, const erp42_msgs__msg__SerialFeedBack__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!erp42_msgs__msg__SerialFeedBack__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  erp42_msgs__msg__SerialFeedBack__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(erp42_msgs__msg__SerialFeedBack);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    erp42_msgs__msg__SerialFeedBack * data =
      (erp42_msgs__msg__SerialFeedBack *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!erp42_msgs__msg__SerialFeedBack__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          erp42_msgs__msg__SerialFeedBack__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!erp42_msgs__msg__SerialFeedBack__copy(
