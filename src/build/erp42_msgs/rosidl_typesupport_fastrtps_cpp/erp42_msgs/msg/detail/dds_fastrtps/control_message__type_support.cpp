...
#include "erp42_msgs/msg/detail/control_message__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const erp42_msgs::msg::ControlMessage & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  erp42_msgs::msg::ControlMessage & ros_message)
{
  // Member: mora
  cdr >> ros_message.mora;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = erp42_msgs::msg::ControlMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const erp42_msgs::msg::ControlMessage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<erp42_msgs::msg::ControlMessage *>(
    untyped_ros_message);
...
{
  return &erp42_msgs::msg::typesupport_fastrtps_cpp::_ControlMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, erp42_msgs, msg, ControlMessage)() {
  return &erp42_msgs::msg::typesupport_fastrtps_cpp::_ControlMessage__handle;
}
