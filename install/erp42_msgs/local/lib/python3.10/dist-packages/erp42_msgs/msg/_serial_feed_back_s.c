...
bool erp42_msgs__msg__serial_feed_back__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("erp42_msgs.msg._serial_feed_back.SerialFeedBack", full_classname_dest, 47) == 0);
  }
  erp42_msgs__msg__SerialFeedBack * ros_message = _ros_message;
  {  // mora
  ...
  {  // brake
    ...
    assert(PyLong_Check(field));
    ros_message->brake = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // encoder
    ...
    assert(PyLong_Check(field));
    ros_message->encoder = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // alive
...
{
  /* NOTE(esteve): Call constructor of SerialFeedBack */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("erp42_msgs.msg._serial_feed_back");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SerialFeedBack");
  ...
  {  // encoder
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->encoder);
    {
