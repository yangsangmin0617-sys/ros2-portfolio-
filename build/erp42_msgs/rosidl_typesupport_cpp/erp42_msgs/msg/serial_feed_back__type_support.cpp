...
static const _SerialFeedBack_type_support_symbol_names_t _SerialFeedBack_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, erp42_msgs, msg, SerialFeedBack)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, erp42_msgs, msg, SerialFeedBack)),
  }
};
...
{
  return &::erp42_msgs::msg::rosidl_typesupport_cpp::SerialFeedBack_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, erp42_msgs, msg, SerialFeedBack)() {
  return get_message_type_support_handle<erp42_msgs::msg::SerialFeedBack>();
}
